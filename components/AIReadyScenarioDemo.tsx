      ...
      <div className="space-y-6">
        <section>
          ...
          <h4 className="text-slate-700 mb-3">
            Scenario Demo: Reply to a Customer Complaint
          </h4>

          <p className="text-sm text-slate-600 mb-4">
            Craft a thoughtful, effective response that acknowledges the issue
            and outlines the fix.
          </p>
        </section>
