...
export default function AndroidPrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-sm leading-7 text-slate-800">
      ...
      <p className="mb-8 text-slate-600">Last updated: March 2026</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          AI Ready uses <strong>Google AdMob (Google Mobile Ads SDK)</strong> to
          display advertisements.
        </p>
        <p className="mb-3">
          AdMob may collect and process certain data to provide personalized and
          non-personalized ads, including:
        </p>
        <ul className="ml-6 list-disc space-y-2">
        ...
        <p className="mt-4 mb-2">For more information, please review:</p>
        <ul className="ml-6 list-disc space-y-2">
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="mt-4">
          We do not collect or store payment information. All billing is handled
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">
          However, certain data may be shared with third-party services (such as
          Google AdMob) for:
        </p>
        <ul className="ml-6 list-disc space-y-2">
          <li>Advertising</li>
      ...
      <section className="mb-8">
        ...
        <p>
          Any data processed by third-party services (such as AdMob) is handled
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          provide account functionality, there is no user data stored by us that
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          Data transmitted through third-party services is encrypted in transit.
        </p>
      </section>
